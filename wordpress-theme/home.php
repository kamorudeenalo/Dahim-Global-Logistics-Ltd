<?php
/**
 * home.php — renders the blog listing when a "Posts page" is assigned
 * under Settings → Reading. This is the "Insights" page.
 */
get_header();
?>
  ...
  <section class="page-header" id="main-content">
    ...
    <div class="wrap">
      ...
      <h1>Logistics news, guides &amp; industry updates.</h1>
      <p class="lead">Practical guidance on freight, customs clearance, and moving cargo through Nigerian ports — from the Dahim team.</p>
    </div>
  </section>
      ...
      <div class="insight-filters-row">
        <?php if ( ! empty( $categories ) ) : ?>
          <div class="insight-filters">
            <a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ); ?>" class="active">All Insights</a>
